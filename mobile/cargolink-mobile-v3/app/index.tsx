...
export default function Index() {
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.btnChargeur} onPress={() => router.push('/inscription?type=chargeur')}>
        <Text style={styles.btnTexte}>Je suis chargeur</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.btnTransporteur} onPress={() => router.push('/inscription?type=transporteur')}>
...
const styles = StyleSheet.create({
  ...
  titre: { fontSize: 32, fontWeight: 'bold', color: 'white', textAlign: 'center', marginBottom: 10 },
  ...
  btnTransporteur: { backgroundColor: 'white', padding: 15, borderRadius: 10, width: '100%', alignItems: 'center', marginBottom: 15, borderWidth: 2, borderColor: '#1F4E79' },
