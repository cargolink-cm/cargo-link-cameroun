...
export default function Index() {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.btnChargeur} onPress={() => navigation.navigate('/inscription')}>
                <Text style={styles.btnTexte}>Je suis chargeur</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.btnTransporteur} onPress={() => navigation.navigate('/inscription')}>
